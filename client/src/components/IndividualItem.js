...
import {deleteMessage, getMessageById, popUpItem, popUpIndex} from '../actions';
        ...
        return (
            <div id={"ItemBox"} className={'boxColor'}>
                ...
                <div className={"center row1"}>
                    {/*need to handle popup somehow....*/}

                    <div className={"column1"}>
                        <p>
                            <img src={this.props.eachItem['smallPosterImageUrl']}/>
                        </p>
                        ...
                        <div className="center itemBoxText" onClick={() => this.popUpSingle()}>
                            <div>
                                <span>
                                    ...
                                    {this.props.eachItem['mpaaRating'] !== null ? <img src={this.props.eachItem['mpaaRating']['imageUrl']}/>:null}
                                    {/*{ <img src={this.props.eachItem['mpaaRating']['imageUrl']}/>}*/}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        deleteMessage: (str) => dispatch(deleteMessage(str)),
